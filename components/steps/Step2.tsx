    ...
    <View style={styles.container}>
      <View>
        ...
        <Text style={styles.subtitle}>
          Your Private key is the key used to back up your wallet. Keep it secret and
          secure all the times.
        </Text>
      </View>
      ...
      <View style={styles.rowButtons}>
        <TouchableOpacity onPress={onBack} activeOpacity={0.8} style={styles.button2}>
